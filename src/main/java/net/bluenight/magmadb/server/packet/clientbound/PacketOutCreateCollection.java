...
public class PacketOutCreateCollection implements Packet {
    private String database;
    private String name;
    private EnumInteractResult result;

    public PacketOutCreateCollection(String database, String name, EnumInteractResult result) {
    ...
    public String toString() {
        return "PacketOutCreateCollection{"
            + "database='" + database + '\''
            + ", name='" + name + '\''
            + ", result=" + result
            + '}';
